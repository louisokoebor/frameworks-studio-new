...
var SessionRecording = /** @class */ (function () {
            ...
            var persistResponse = function () {
                ...
                persistence_1.register((_a = {},
                    _a[constants_1.SESSION_RECORDING_REMOTE_CONFIG] = __assign(__assign({ cache_timestamp: Date.now(), enabled: !!sessionRecordingConfigResponse }, sessionRecordingConfigResponse), { networkPayloadCapture: __assign({ capturePerformance: response.capturePerformance }, sessionRecordingConfigResponse === null || sessionRecordingConfigResponse === void 0 ? void 0 : sessionRecordingConfigResponse.networkPayloadCapture), canvasRecording: {
                        ...
                        version: sessionRecordingConfigResponse === null || sessionRecordingConfigResponse === void 0 ? void 0 : sessionRecordingConfigResponse.version, triggerGroups: sessionRecordingConfigResponse === null || sessionRecordingConfigResponse === void 0 ? void 0 : sessionRecordingConfigResponse.triggerGroups }),
                    _a));
            };
            persistResponse();
    ...
    SessionRecording.prototype._onScriptLoaded = function (startReason) {
        var _a;
        var _b, _c;
        if (!((_b = globals_1.assignableWindow.__PosthogExtensions__) === null || _b === void 0 ? void 0 : _b.initSessionRecording)) {
            ...
            this._instance.register_for_session((_a = {},
                _a[constants_1.SDK_DEBUG_RECORDING_SCRIPT_NOT_LOADED] = true,
                _a));
            return;
        }
        if (!this._lazyLoadedSessionRecording) {
            this._lazyLoadedSessionRecording = (_c = globals_1.assignableWindow.__PosthogExtensions__) === null || _c === void 0 ? void 0 : _c.initSessionRecording(this._instance);
