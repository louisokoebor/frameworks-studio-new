...
function compressEvent(event) {
    try {
        if (event.type === rrweb_types_1.EventType.FullSnapshot) {
            var compressed = __assign(__assign({}, event), { data: gzipToString(event.data), cv: '2024-10' });
            return { event: compressed, size: (0, sessionrecording_utils_1.estimateCompressedEventSize)(compressed) };
        }
        if (event.type === rrweb_types_1.EventType.IncrementalSnapshot && event.data.source === rrweb_types_1.IncrementalSource.Mutation) {
            var compressed = __assign(__assign({}, event), { cv: '2024-10', data: __assign(__assign({}, event.data), { texts: gzipField(event.data.texts), attributes: gzipField(event.data.attributes), removes: gzipField(event.data.removes), adds: gzipField(event.data.adds) }) });
            return { event: compressed, size: (0, sessionrecording_utils_1.estimateCompressedEventSize)(compressed) };
        }
        if (event.type === rrweb_types_1.EventType.IncrementalSnapshot && event.data.source === rrweb_types_1.IncrementalSource.StyleSheetRule) {
            var compressed = __assign(__assign({}, event), { cv: '2024-10', data: __assign(__assign({}, event.data), { adds: event.data.adds ? gzipToString(event.data.adds) : undefined, removes: event.data.removes ? gzipToString(event.data.removes) : undefined }) });
            return { event: compressed, size: (0, sessionrecording_utils_1.estimateCompressedEventSize)(compressed) };
        }
    }
    catch (e) {
...
var LazyLoadedSessionRecording = /** @class */ (function () {
    ...
    Object.defineProperty(LazyLoadedSessionRecording.prototype, "_fullSnapshotIntervalMillis", {
        get: function () {
            ...
            return (_c = (_b = this._instance.config.session_recording) === null || _b === void 0 ? void 0 : _b.full_snapshot_interval_millis) !== null && _c !== void 0 ? _c : FIVE_MINUTES;
        },
        enumerable: false,
        configurable: true
    });
    ...
    LazyLoadedSessionRecording.prototype.start = function (startReason) {
        ...
        if (isV2) {
            this._strategy = new recording_strategies_1.V2TriggerGroupStrategy(this._instance, this._urlTriggerMatching, this._reportStarted.bind(this), this._tryAddCustomEvent.bind(this));
        }
        else {
            this._strategy = new recording_strategies_1.V1RecordingStrategy(this._instance, this._urlTriggerMatching, this._eventTriggerMatching, this._linkedFlagMatching, this._reportStarted.bind(this), this._tryTakeFullSnapshot.bind(this));
        }
    ...
    LazyLoadedSessionRecording.prototype._teardown = function () {
        ...
        this._forceIdleSessionIdListener = undefined;
        (_g = this._strategy) === null || _g === void 0 ? void 0 : _g.stop();
        (_h = this._mutationThrottler) === null || _h === void 0 ? void 0 : _h.stop();
        // Clear any queued rrweb events to prevent memory leaks from closures
        this._queuedRRWebEvents = [];
        (_j = this._stopRrweb) === null || _j === void 0 ? void 0 : _j.call(this);
        this._stopRrweb = undefined;
    };
    ...
    LazyLoadedSessionRecording.prototype.onRRwebEmit = function (rawEvent) {
        ...
        if (rawEvent.type === rrweb_types_1.EventType.FullSnapshot) {
            ...
            (_c = this._mutationThrottler) === null || _c === void 0 ? void 0 : _c.reset();
            ...
            (_d = this._instance.persistence) === null || _d === void 0 ? void 0 : _d.register_once((_a = {},
                _a[constants_1.SESSION_RECORDING_FIRST_FULL_SNAPSHOT_TIMESTAMP] = rawEvent.timestamp,
                _a), undefined);
        }
        // Clear the buffer if waiting for a trigger and only keep data from after the current full snapshot
        if (rawEvent.type === rrweb_types_1.EventType.FullSnapshot && ((_e = this._strategy) === null || _e === void 0 ? void 0 : _e.hasPendingTriggers(this.sessionId))) {
        ...
        var targetSessionId = (_g = (_f = sessionEndingPayload === null || sessionEndingPayload === void 0 ? void 0 : sessionEndingPayload.currentSessionId) !== null && _f !== void 0 ? _f : sessionStartingPayload === null || sessionStartingPayload === void 0 ? void 0 : sessionStartingPayload.nextSessionId) !== null && _g !== void 0 ? _g : this._sessionId;
        var targetWindowId = (_j = (_h = sessionEndingPayload === null || sessionEndingPayload === void 0 ? void 0 : sessionEndingPayload.currentWindowId) !== null && _h !== void 0 ? _h : sessionStartingPayload === null || sessionStartingPayload === void 0 ? void 0 : sessionStartingPayload.nextWindowId) !== null && _j !== void 0 ? _j : this._windowId;
        ...
        var _o = ((_k = this._instance.config.session_recording.compress_events) !== null && _k !== void 0 ? _k : true)
            ? compressEvent(event)
            : { event: event, size: (0, sessionrecording_utils_1.estimateSize)(event) }, eventToSend = _o.event, size = _o.size;
        var properties = {
            $snapshot_bytes: size,
        ...
        if (event.type === rrweb_types_1.EventType.FullSnapshot && ((_m = (_l = getRRWeb()) === null || _l === void 0 ? void 0 : _l.wasMaxDepthReached) === null || _m === void 0 ? void 0 : _m.call(_l))) {
    ...
    LazyLoadedSessionRecording.prototype._flushBuffer = function () {
        ...
        if (this._buffer.data.length > 0) {
            ...
            (_a = this._strategy) === null || _a === void 0 ? void 0 : _a.onFlushComplete();
        }
