...
import type { CheckboxStoreProps, CheckboxStoreValue } from "./checkbox-store.ts";
 ...
 * ```
 */
export declare function CheckboxProvider<T extends Value = Value>(props: PickRequired<CheckboxProviderProps<T>, "value" | "defaultValue">): ReactElement;
export declare function CheckboxProvider(props?: CheckboxProviderProps): ReactElement;
export interface CheckboxProviderProps<T extends Value = Value> extends CheckboxStoreProps<T> {
    children?: ReactNode;
}
export {};
