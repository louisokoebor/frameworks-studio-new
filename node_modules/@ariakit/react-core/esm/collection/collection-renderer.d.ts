...
import type { CollectionStore, CollectionStoreItem } from "./collection-store.ts";
...
export declare const CollectionRenderer: <T extends Item = any>(props: CollectionRendererProps<T>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
...
export interface CollectionRendererOptions<T extends Item = any> extends Options {
    /**
...
export interface CollectionRendererProps<T extends Item = any> extends Props<TagName, CollectionRendererOptions<T>> {
}
export {};
