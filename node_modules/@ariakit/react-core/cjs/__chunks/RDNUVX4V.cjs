...
function useStoreState(store, keyOrSelector = _misc.identity) {
  ...
  return _shim.useSyncExternalStore.call(void 0, storeSubscribe, getSnapshot, getSnapshot);
}
...
function useStoreProps(store, props, key, setKey) {
  ...
  const propsRef = _4KGS3DOWcjs.useLiveRef.call(void 0, { value, setValue });
...
function useStore(createStore, props) {
  ...
  _4KGS3DOWcjs.useSafeLayoutEffect.call(void 0, () => _store.init.call(void 0, store), [store]);
  ...
  const updateStore = _4KGS3DOWcjs.useEvent.call(void 0, () => {
