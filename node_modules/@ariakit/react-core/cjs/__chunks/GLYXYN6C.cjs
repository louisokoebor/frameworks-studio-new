...
function useCollectionItemOffscreen({ offscreenMode = "active", offscreenRoot, ...props }) {
  ...
  const [updated, forceUpdate] = _4KGS3DOWcjs.useForceUpdate.call(void 0, );
  const forcedUpdatesCountRef = _react.useRef.call(void 0, 0);
  const [_active, setActive] = _react.useState.call(void 0, offscreenMode === "active");
...
var CollectionItem2 = _SQLDFLTEcjs.forwardRef.call(void 0, function CollectionItem3({
  offscreenMode,
  offscreenRoot,
  ...props
}) {
  ...
  if (active) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _QM74NV6Dcjs.CollectionItem, { ...allProps });
  }
  const {
    store,
    shouldRegisterItem,
