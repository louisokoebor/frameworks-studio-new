...
var _6SC6IEJJcjs = require('./6SC6IEJJ.cjs');



var _7X7JMIHXcjs = require('./7X7JMIHX.cjs');
...
var usePopover = _SQLDFLTEcjs.createHook.call(void 0, 
  function usePopover2({
    ...
    const context = _7X7JMIHXcjs.usePopoverProviderContext.call(void 0, );
    store = store || context;
    _misc.invariant.call(void 0, 
      store,
      process.env.NODE_ENV !== "production" && "Popover must receive a `store` prop or be wrapped in a PopoverProvider component."
    );
    const arrowElement = _RDNUVX4Vcjs.useStoreState.call(void 0, store, "arrowElement");
    const anchorElement = _RDNUVX4Vcjs.useStoreState.call(void 0, store, "anchorElement");
    const disclosureElement = _RDNUVX4Vcjs.useStoreState.call(void 0, store, "disclosureElement");
    const popoverElement = _RDNUVX4Vcjs.useStoreState.call(void 0, store, "popoverElement");
    ...
    const rendered = _RDNUVX4Vcjs.useStoreState.call(void 0, store, "rendered");
    ...
    const { portalRef, domReady } = _4KGS3DOWcjs.usePortalRef.call(void 0, portal, props.portalRef);
    const getAnchorRectProp = _4KGS3DOWcjs.useEvent.call(void 0, getAnchorRect);
    const updatePositionProp = _4KGS3DOWcjs.useEvent.call(void 0, updatePosition);
    ...
    props = _4KGS3DOWcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _7X7JMIHXcjs.PopoverScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
    ...
    props = _6SC6IEJJcjs.useDialog.call(void 0, {
      store,
      modal,
      portal,
      preserveTabOrder,
...
var Popover = _6SC6IEJJcjs.createDialogComponent.call(void 0, 
  _SQLDFLTEcjs.forwardRef.call(void 0, function Popover2(props) {
    const htmlProps = usePopover(props);
    return _SQLDFLTEcjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _7X7JMIHXcjs.usePopoverProviderContext
);
