...
var _QM74NV6Dcjs = require('./QM74NV6D.cjs');
...
var _HAR6UDZUcjs = require('./HAR6UDZU.cjs');
...
function findNextPageItemId(element, store, next, pageUp = false) {
  ...
  for (let i = 0; i < renderedItems.length; i += 1) {
    ...
    const itemElement = (_a = _2XVCJUVBcjs.getEnabledItem.call(void 0, store, id)) == null ? void 0 : _a.element;
...
function targetIsAnotherItem(event, store) {
  ...
  return _2XVCJUVBcjs.isItem.call(void 0, store, event.target);
}
var useCompositeItem = _SQLDFLTEcjs.createHook.call(void 0, 
  function useCompositeItem2({
    ...
    const row = _react.useContext.call(void 0, _EOGOO37Xcjs.CompositeRowContext);
    ...
    const {
      ...
      ariaPosInSet,
      isTabbable
    } = _RDNUVX4Vcjs.useStoreStateObject.call(void 0, store, {
      rowId(state) {
    ...
    const onFocus = _4KGS3DOWcjs.useEvent.call(void 0, (event) => {
      ...
      if (_dom.isTextbox.call(void 0, event.currentTarget)) {
        _2XVCJUVBcjs.selectTextField.call(void 0, event.currentTarget);
      }
      ...
      const fromComposite = event.relatedTarget === baseElement2 || _2XVCJUVBcjs.isItem.call(void 0, store, event.relatedTarget);
      if (fromComposite) {
        _2XVCJUVBcjs.focusSilently.call(void 0, baseElement2);
      } else {
        baseElement2.focus();
      }
    });
    ...
    const preventScrollOnKeyDownProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, preventScrollOnKeyDown);
    ...
    props = _4KGS3DOWcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _EOGOO37Xcjs.CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = {
    ...
    props = _HAR6UDZUcjs.useCommand.call(void 0, props);
    props = _QM74NV6Dcjs.useCollectionItem.call(void 0, {
      store,
      ...props,
      getItem,
...
var CompositeItem = _SQLDFLTEcjs.memo.call(void 0, 
  _SQLDFLTEcjs.forwardRef.call(void 0, function CompositeItem2(props) {
