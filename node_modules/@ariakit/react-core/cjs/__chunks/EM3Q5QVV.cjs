...
var _XRHNSFIKcjs = require('./XRHNSFIK.cjs');
...
function useDialogStoreProps(store, update, props) {
  return _XRHNSFIKcjs.useDisclosureStoreProps.call(void 0, store, update, props);
}
function useDialogStore(props = {}) {
  const [store, update] = _RDNUVX4Vcjs.useStore.call(void 0, Core.createDialogStore, props);
