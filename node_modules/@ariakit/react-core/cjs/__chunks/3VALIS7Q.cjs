...
var useCompositeHover = _SQLDFLTEcjs.createHook.call(void 0, 
  function useCompositeHover2({
    ...
    const isMouseMoving = _4KGS3DOWcjs.useIsMouseMoving.call(void 0, );
    const onMouseMoveProp = props.onMouseMove;
    const focusOnHoverProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, focusOnHover);
    const onMouseMove = _4KGS3DOWcjs.useEvent.call(void 0, (event) => {
    ...
    const blurOnHoverEndProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, blurOnHoverEnd);
    const onMouseLeave = _4KGS3DOWcjs.useEvent.call(void 0, (event) => {
      var _a;
...
var CompositeHover = _SQLDFLTEcjs.memo.call(void 0, 
  _SQLDFLTEcjs.forwardRef.call(void 0, function CompositeHover2(props) {
