...
var useCompositeContainer = _SQLDFLTEcjs.createHook.call(void 0, function useCompositeContainer2({ store, ...props }) {
  ...
  const open = (collapseToEnd = false) => {
    ...
    queueMicrotask(() => {
      ...
      if (_dom.isTextField.call(void 0, tabbable) || tabbable.isContentEditable) {
        _2XVCJUVBcjs.selectTextField.call(void 0, tabbable, collapseToEnd);
      }
    });
  };
  const close = () => {
  ...
  const renderedItems = _RDNUVX4Vcjs.useStoreState.call(void 0, store, "renderedItems");
...
var CompositeContainer = _SQLDFLTEcjs.forwardRef.call(void 0, function CompositeContainer2(props) {
