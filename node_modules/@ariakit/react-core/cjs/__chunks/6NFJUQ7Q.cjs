...
var _3PV6Y4XHcjs = require('./3PV6Y4XH.cjs');
...
var _TWX5YNTHcjs = require('./TWX5YNTH.cjs');
...
var usePortal = _SQLDFLTEcjs.createHook.call(void 0, function usePortal2({
  preserveTabOrder,
  ...
  const refProp = _4KGS3DOWcjs.useMergeRefs.call(void 0, ref, props.ref);
  ...
  _4KGS3DOWcjs.useSafeLayoutEffect.call(void 0, () => {
    ...
    _TWX5YNTHcjs.setRef.call(void 0, portalRef, portalEl);
    if (isPortalInDocument) return;
    return () => {
      portalEl.remove();
      _TWX5YNTHcjs.setRef.call(void 0, portalRef, null);
    };
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const doc = _dom.getDocument.call(void 0, portalNode);
...
var Portal = _SQLDFLTEcjs.forwardRef.call(void 0, function Portal2(props) {
