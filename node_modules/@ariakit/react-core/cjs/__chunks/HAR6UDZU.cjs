...
var useCommand = _SQLDFLTEcjs.createHook.call(void 0, 
  function useCommand2({ clickOnEnter = true, clickOnSpace = true, ...props }) {
    ...
    const [isDuplicate, metadataProps] = _4KGS3DOWcjs.useMetadataProps.call(void 0, props, symbol, true);
    ...
    const onKeyUp = _4KGS3DOWcjs.useEvent.call(void 0, (event) => {
    ...
    props = _BB34VMZXcjs.useFocusable.call(void 0, props);
    return props;
  }
);
var Command = _SQLDFLTEcjs.forwardRef.call(void 0, function Command2(props) {
