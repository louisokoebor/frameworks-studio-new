...
function useCollectionStoreProps(store, update, props) {
  _4KGS3DOWcjs.useUpdateEffect.call(void 0, update, [props.store]);
  _RDNUVX4Vcjs.useStoreProps.call(void 0, store, props, "items", "setItems");
  return store;
}
function useCollectionStore(props = {}) {
  const [store, update] = _RDNUVX4Vcjs.useStore.call(void 0, Core.createCollectionStore, props);
