...
var usePopoverArrow = _SQLDFLTEcjs.createHook.call(void 0, 
  function usePopoverArrow2({
    ...
    const context = _7X7JMIHXcjs.usePopoverContext.call(void 0, );
    store = store || context;
    ...
    const maskId = _4KGS3DOWcjs.useId.call(void 0, );
    ...
    props = {
      ...
      "aria-hidden": true,
      ...props,
      ref: _4KGS3DOWcjs.useMergeRefs.call(void 0, store.setArrowElement, props.ref),
      style: {
        position: "absolute",
        fontSize: size,
        width: "1em",
...
var PopoverArrow = _SQLDFLTEcjs.memo.call(void 0, 
  _SQLDFLTEcjs.forwardRef.call(void 0, function PopoverArrow2(props) {
