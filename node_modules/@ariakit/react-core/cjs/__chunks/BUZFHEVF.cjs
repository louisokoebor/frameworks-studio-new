...
var _EB6DQJGWcjs = require('./EB6DQJGW.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _EB6DQJGWcjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
...
function useCompositeRenderer({
  ...
  return _EB6DQJGWcjs.useCollectionRenderer.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices,
...
var CompositeRenderer = _SQLDFLTEcjs.forwardRef.call(void 0, function CompositeRenderer2(props) {
