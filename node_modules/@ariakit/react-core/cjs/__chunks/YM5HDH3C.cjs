...
function getSameInitialItems(items, char, activeId) {
  ...
  chars = char;
  return _2XVCJUVBcjs.flipItems.call(void 0, 
    items.filter((item) => itemTextStartsWith(item, chars)),
    activeId
  ).filter((item) => item.id !== activeId);
}
var useCompositeTypeahead = _SQLDFLTEcjs.createHook.call(void 0, function useCompositeTypeahead2({ store, typeahead = true, ...props }) {
  ...
  const onKeyDownCapture = _4KGS3DOWcjs.useEvent.call(void 0, (event) => {
...
var CompositeTypeahead = _SQLDFLTEcjs.forwardRef.call(void 0, function CompositeTypeahead2(props) {
