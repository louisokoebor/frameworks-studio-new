...
var _QB525TJGcjs = require('./QB525TJG.cjs');
...
var useCheckbox = _SQLDFLTEcjs.createHook.call(void 0, 
  function useCheckbox2({
    ...
    const context = _QB525TJGcjs.useCheckboxContext.call(void 0, );
    store = store || context;
    const [_checked, setChecked] = _react.useState.call(void 0, defaultChecked != null ? defaultChecked : false);
    const checked = _RDNUVX4Vcjs.useStoreState.call(void 0, store, (state) => {
    ...
    props = _HAR6UDZUcjs.useCommand.call(void 0, { clickOnEnter: !nativeCheckbox, ...props });
...
var Checkbox = _SQLDFLTEcjs.forwardRef.call(void 0, function Checkbox2(props) {
