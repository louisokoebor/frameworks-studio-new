...
function createElement(Type, props) {
  ...
  const mergedRef = _4KGS3DOWcjs.useMergeRefs.call(void 0, props.ref, _TWX5YNTHcjs.getRefProperty.call(void 0, render));
  let element;
  if (React.isValidElement(render)) {
    ...
    element = React.cloneElement(render, _TWX5YNTHcjs.mergeProps.call(void 0, rest, renderProps));
  } else if (render) {
    element = render(rest);
  } else {
