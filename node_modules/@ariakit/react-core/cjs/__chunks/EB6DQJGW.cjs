...
var _ZYZTL3IQcjs = require('./ZYZTL3IQ.cjs');
...
function useCollectionRenderer({
  ...
  var _a, _b;
  const context = _ZYZTL3IQcjs.useCollectionContext.call(void 0, );
  store = store || context;
  const items = _RDNUVX4Vcjs.useStoreState.call(void 0, 
    store,
  ...
  const orientation = (_a = orientationProp != null ? orientationProp : parent == null ? void 0 : parent.orientation) != null ? _a : "vertical";
  const overscan = (_b = overscanProp != null ? overscanProp : parent == null ? void 0 : parent.overscan) != null ? _b : 1;
  const ref = _react.useRef.call(void 0, null);
  const baseId = _4KGS3DOWcjs.useId.call(void 0, props.id);
  const horizontal = orientation === "horizontal";
  const elements = _react.useMemo.call(void 0, () => /* @__PURE__ */ new Map(), []);
  const [elementsUpdated, updateElements] = _4KGS3DOWcjs.useForceUpdate.call(void 0, );
  ...
  const processVisibleIndices = _react.useCallback.call(void 0, () => {
    ...
    const getItemOffset = (index, prop = "start") => {
      ...
      return (_a2 = itemData == null ? void 0 : itemData[prop]) != null ? _a2 : 0;
    };
  ...
  const processVisibleIndicesEvent = _4KGS3DOWcjs.useEvent.call(void 0, processVisibleIndices);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnScrollProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, renderOnScroll);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnResizeProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, renderOnResize);
  _react.useEffect.call(void 0, () => {
  ...
  const getItemProps = _react.useCallback.call(void 0, 
    (item, index) => {
      var _a2, _b2;
      const itemId = getItemId(item, index, baseId);
      const offset = itemSize ? paddingStart + itemSize * index + gap * index : (_b2 = (_a2 = data.get(itemId)) == null ? void 0 : _a2.start) != null ? _b2 : 0;
      const baseItemProps = {
        id: itemId,
        ref: itemRef,
        index,
...
var CollectionRenderer = _SQLDFLTEcjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
