...
var _5ABIDBW2cjs = require('../__chunks/5ABIDBW2.cjs');
...
var TagName = "button";
var useTagRemove = _SQLDFLTEcjs.createHook.call(void 0, 
  function useTagRemove2({
    ...
    const context = _5ABIDBW2cjs.useTagContext.call(void 0, );
    store = store || context;
    ...
    const setRemoveId = _react.useContext.call(void 0, _5ABIDBW2cjs.TagRemoveIdContext);
    const valueFromContext = _react.useContext.call(void 0, _5ABIDBW2cjs.TagValueContext);
    ...
    const removeOnClickProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, removeOnClick);
    ...
    props = {
      ...
      id,
      onClick,
      render: withinTag ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _4IRVZ6J3cjs.Role.span, { render: props.render }) : props.render
    };
    return props;
  }
);
var TagRemove = _SQLDFLTEcjs.forwardRef.call(void 0, function TagRemove2(props) {
