 ...
 * ```
 */
export declare const useFormField: import("../utils/types.ts").Hook<"input", FormFieldOptions<"input">>;
/**
 ...
 * ```
 */
export declare const FormField: (props: FormFieldProps) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
export interface FormFieldOptions<T extends ElementType = TagName> extends FormControlOptions<T> {
}
export type FormFieldProps<T extends ElementType = TagName> = Props<T, FormFieldOptions<T>>;
export {};
