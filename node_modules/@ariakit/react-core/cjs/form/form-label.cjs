...
var useFormLabel = _SQLDFLTEcjs.createHook.call(void 0, 
  function useFormLabel2({
    ...
    const field = _RDNUVX4Vcjs.useStoreState.call(void 0, 
      store,
      (state) => state.items.find((item) => item.type === "field" && item.name === name)
    );
    const fieldTagName = _4KGS3DOWcjs.useTagName.call(void 0, field == null ? void 0 : field.element, "input");
...
var FormLabel = _SQLDFLTEcjs.memo.call(void 0, 
  _SQLDFLTEcjs.forwardRef.call(void 0, function FormLabel2(props) {
