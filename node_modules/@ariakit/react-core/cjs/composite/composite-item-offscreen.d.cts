...
export declare function useCompositeItemOffscreen<T extends ElementType, P extends CompositeItemProps<T>>({ store, offscreenMode, disabled, value, ...props }: P): {
    id: string | undefined;
    active: boolean;
...
export declare const CompositeItem: ({ offscreenMode, offscreenRoot, ...props }: CompositeItemProps) => import("react/jsx-runtime").JSX.Element;
