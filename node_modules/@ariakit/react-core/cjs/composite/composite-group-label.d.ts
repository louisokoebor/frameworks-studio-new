 ...
 * ```
 */
export declare const useCompositeGroupLabel: import("../utils/types.ts").Hook<"div", CompositeGroupLabelOptions<"div">>;
/**
 ...
 * ```
 */
export declare const CompositeGroupLabel: (props: CompositeGroupLabelProps) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
export interface CompositeGroupLabelOptions<T extends ElementType = TagName> extends GroupLabelOptions<T> {
    /**
...
export type CompositeGroupLabelProps<T extends ElementType = TagName> = Props<T, CompositeGroupLabelOptions<T>>;
export {};
