...
export declare function useCollectionItemOffscreen<T extends ElementType, P extends CollectionItemProps<T>>({ offscreenMode, offscreenRoot, ...props }: P): {
    id: string | undefined;
    active: boolean;
    ref: RefCallback<HTMLDivElement>;
    "data-offscreen": true | undefined;
};
export declare const CollectionItem: ({ offscreenMode, offscreenRoot, ...props }: CollectionItemProps) => import("react/jsx-runtime").JSX.Element;
