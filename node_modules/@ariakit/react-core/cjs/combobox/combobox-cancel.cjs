...
var _F6OAWDMCcjs = require('../__chunks/F6OAWDMC.cjs');
...
var useComboboxCancel = _SQLDFLTEcjs.createHook.call(void 0, 
  function useComboboxCancel2({ store, hideWhenEmpty, ...props }) {
    ...
    const comboboxId = _RDNUVX4Vcjs.useStoreState.call(void 0, store, (state) => {
      var _a;
      return (_a = state.baseElement) == null ? void 0 : _a.id;
    });
    const empty = _RDNUVX4Vcjs.useStoreState.call(void 0, store, (state) => state.value === "");
    ...
    props = _F6OAWDMCcjs.useButton.call(void 0, props);
    return props;
  }
);
var ComboboxCancel = _SQLDFLTEcjs.forwardRef.call(void 0, function ComboboxCancel2(props) {
