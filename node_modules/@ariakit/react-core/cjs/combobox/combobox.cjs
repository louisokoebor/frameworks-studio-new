...
var _VKWO5RWCcjs = require('../__chunks/VKWO5RWC.cjs');
...
var useCombobox = _SQLDFLTEcjs.createHook.call(void 0, 
  function useCombobox2({
    ...
    const [valueUpdated, forceValueUpdate] = _4KGS3DOWcjs.useForceUpdate.call(void 0, );
    const canAutoSelectRef = _react.useRef.call(void 0, false);
    const composingRef = _react.useRef.call(void 0, false);
    const autoSelect = _RDNUVX4Vcjs.useStoreState.call(void 0, 
      store,
      (state) => state.virtualFocus && autoSelectProp
    );
    const inline = autoComplete === "inline" || autoComplete === "both";
    const [canInline, setCanInline] = _react.useState.call(void 0, inline);
    _4KGS3DOWcjs.useUpdateLayoutEffect.call(void 0, () => {
      if (!inline) return;
      setCanInline(true);
    }, [inline]);
    const storeValue = _RDNUVX4Vcjs.useStoreState.call(void 0, store, "value");
    ...
    const inlineActiveValue = _RDNUVX4Vcjs.useStoreState.call(void 0, store, (state) => {
      var _a;
      if (!inline) return;
      if (!canInline) return;
    ...
    const getAutoSelectIdProp = _4KGS3DOWcjs.useEvent.call(void 0, getAutoSelectId);
    ...
    const resetValueOnSelect = _RDNUVX4Vcjs.useStoreState.call(void 0, store, "resetValueOnSelect");
    _4KGS3DOWcjs.useUpdateEffect.call(void 0, () => {
      var _a, _b;
    ...
    const showOnChangeProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, showOnChange != null ? showOnChange : canShow);
    const setValueOnChangeProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, 
    ...
    const onCompositionEnd = _4KGS3DOWcjs.useEvent.call(void 0, (event) => {
      canAutoSelectRef.current = true;
    ...
    const blurActiveItemOnClickProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, 
    ...
    const showOnClickProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, showOnClick != null ? showOnClick : canShow);
    ...
    const showOnKeyPressProp = _4KGS3DOWcjs.useBooleanEvent.call(void 0, showOnKeyPress != null ? showOnKeyPress : canShow);
    ...
    const isActiveItem = _RDNUVX4Vcjs.useStoreState.call(void 0, 
      store,
    ...
    props = _DN4TDPKMcjs.useComposite.call(void 0, {
      store,
      focusable,
      ...props,
    ...
    props = _VKWO5RWCcjs.usePopoverAnchor.call(void 0, { store, ...props });
    return { autoComplete: "off", ...props };
  }
);
var Combobox = _SQLDFLTEcjs.forwardRef.call(void 0, function Combobox2(props) {
