...
function createSlot3(ownerName) {
  ...
  const Slot22 = React29.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React29.Children.count(newElement) > 1)
            return React29.Children.only(null);
...
function useSize(element) {
  const [size2, setSize] = React33.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperContent = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React34.useState(null);
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React36.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime16.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React36.isValidElement(newElement) ? React36.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React36.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React39.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime19.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React39.isValidElement(newElement) ? React39.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var VisuallyHidden = React40.forwardRef(
  (props, forwardedRef) => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime21.jsx)(PortalProvider3, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime21.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContent = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime21.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime21.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime21.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React41.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime21.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable6 = createSlottable5("TooltipContent");
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime21.jsxs)(
          Content2,
          {
            ...
            children: [
              (0, import_jsx_runtime21.jsx)(Slottable6, { children }),
              (0, import_jsx_runtime21.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime21.jsx)(Root4, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime21.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
//# sourceMappingURL=chunk-SQCLCULW.js.map
